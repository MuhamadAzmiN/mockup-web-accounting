    ...
    <section class="container px-4 mx-auto mt-8">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <div>
                ...
                <h2 class="mt-2 text-2xl font-bold text-gray-800 dark:text-white">Create New Product</h2>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">Add a new product to your inventory</p>
            </div>
        </div>
