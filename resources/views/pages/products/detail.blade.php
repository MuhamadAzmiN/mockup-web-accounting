    ...
    <section class="container px-4 mx-auto mt-8">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <div>
                ...
                <h2 class="mt-2 text-2xl font-bold text-gray-800 dark:text-white">Product Details</h2>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">View detailed information about this product</p>
            </div>
            <div class="flex items-center mt-4 sm:mt-0">
                <a href="{{ route('products.edit', $product) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:bg-gray-600 dark:text-gray-200 dark:border-gray-500 dark:hover:bg-gray-500 transition-colors duration-200 mr-3">
