<div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-xs rounded-xl">
    <div class="px-5 pt-5">
        <header class="flex justify-between items-start mb-2">
            <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-100">Total Expenditure</h2>
            <!-- Menu button -->
        ...
        <div class="flex items-start">
            <div class="text-2xl font-bold text-gray-800 dark:text-gray-100 mr-2">Rp{{ number_format($getTotalExpenditure['total_product_purchased'], 0, ',', '.') }}</div>
